...
def WeedSpec_FCN_16(input_shape = None, weight_decay=0., batch_momentum=0.9, batch_shape=None, classes=2):
	...
	if batch_shape:
       	 	model.add(ZeroPadding2D((1, 1) , batch_input_shape=batch_shape))
        	image_size = batch_shape[1:3]
    	else:
	...
	model.add(Convolution2D(32, (3, 3), border_mode='same', activation = 'relu', name = 'con_2'))
	model.add(MaxPooling2D((2,2), strides=(2,2)))


	model.add(Convolution2D(64, (3, 3), border_mode='same', activation = 'relu', name = 'con_3'))
	model.add(Convolution2D(64, (3, 3), border_mode='same', activation = 'relu', name = 'con_4'))
	model.add(MaxPooling2D((2,2), strides=(2,2)))
	model.add(Convolution2D(64, (3, 3), border_mode='same', activation = 'relu', name = 'con_5'))
	model.add(MaxPooling2D((2,2), strides=(2,2)))

	#Convolution layers UpSample
	model.add(Convolution2D(64, (3,3), border_mode='same', activation = 'relu', name = 'con_1_up'))
	model.add(UpSampling2D((2,2)))
	model.add(Convolution2D(64, (3,3), border_mode='same', activation = 'relu', name = 'con_2_up'))
	model.add(Convolution2D(64, (3,3), border_mode='same', activation = 'relu', name = 'con_3_up'))
	model.add(UpSampling2D((2,2)))

	model.add(Convolution2D(32, (3,3), border_mode='same', activation = 'relu', name = 'con_4_up'))
	model.add(UpSampling2D((2,2)))
	model.add(Convolution2D(32, (3,3), border_mode='same', activation = 'relu', name = 'con_5_up'))
	model.add(UpSampling2D((2,2)))
	model.add(Convolution2D(1, (1,1), border_mode='same', activation = 'relu', name = 'final_conv'))
